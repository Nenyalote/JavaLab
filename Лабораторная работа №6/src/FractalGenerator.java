...
public abstract class FractalGenerator {
  ...
  /**
   * Given a coordinate <em>x</em> + <em>iy</em> in the complex plane, computes and returns the number of iterations
   * before the fractal function escapes the bounding area for that point.  A point that doesn't escape before the
